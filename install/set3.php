	  ...
	  <legend><strong>数据库信息</strong></legend>
		...
		<div class="section1">
		 ...
		 <input type="text" name="dbname" class="text" size="18" />
		  <span>例如'sql'或'my_sql',请确保用字母开头</span>
		</div>
		<div class="section1">
		  <p>数据库用户名</p>
		...
		<div style="padding:8px 0px 8px 80px;">
		     <span style="color:#FF0000">系统默认登陆账号:admin  密码:hsmiao1968   登陆系统后您可以自行改密码 </span>
		</div>
		...
		<div class="section1" style="margin-bottom:0px;">
		  <p>登陆密码</p>
		  <input type="text" class="text" readonly="" value="hsmiao1968" />
		</div>
      </fieldset>
