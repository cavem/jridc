...
<div class="centercontent tables">
        <div class="pageheader notab">
            <h1 class="pagetitle20">短信接口管理</h1>
            <span class="pagedesc">短信接口管理</span>
        </div><!--pageheader-->
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1">默认</th>
                            <th class="head0">设置</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php if(is_array($Sms)): $i = 0; $__LIST__ = $Sms;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo["sms_id"]); ?></td>
                            <td><?php echo ($vo["sms_company"]); ?></td>
                             <td class="center">
                           <?php if($vo[sms_default] == 1): ?><img  src="__PUBLIC__/Admin/images/icons/icon_1.png" alt="启用" title="启用">
					                          <?php else: ?>
					       <img  src="__PUBLIC__/Admin/images/icons/icon_0.png" alt="启用" title="启用"><?php endif; ?>
                             </td>
                            <td class="center">
                			    <a href="<?php echo U('Admin/Sms/edit',array('id'=>$vo['sms_id']));?>" class="edit">设置</a> &nbsp;
                 			   <a href="#del" >
                  			   <span href="<?php echo U('Admin/Sms/set',array('id'=>$vo['sms_id']));?>" class="confirmbutton">默认接口</span>
                  			   </a> &nbsp;
