...
<div class="vernav2 iconmenu">
 ...
 <a class="togglemenu"></a>
		...
		<div class="pageheader notab">
			<h1 class="pagetitle20">编辑单页</h1>
			<span class="pagedesc">编辑单页</span>
		</div><!--pageheader-->
		<div id="contentwrapper" class="contentwrapper">
			<div id="basicform" class="subcontent">
			<form class="stdform formvalidate" action="<?php echo U('Admin/Page/edit');?>" method="post">
				<p><label>标题</label>
				<span class="field">
					<input type="text" name="title" id="title" value='<?php echo ($data["title"]); ?>' class="smallinput20" validate='{required:true,messages:{required:"不能为空"}}' />
				</span></p>
				<p><label>所属菜单编号</label>
				<span class="field">
					<input type="text" name="type_id" id="type_id" value='<?php echo ($data["type_id"]); ?>' class="smallinput20" validate='{required:true,isIntGteZero:true,messages:{required:"不能为空"}}' />
				</span></p>
				<p><label>关键词</label>
				<span class="field">
					<input type="text" name="keyword" id="keyword" value='<?php echo ($data["keyword"]); ?>' class="smallinput20" />
				</span></p>
				<p><label>内容</label>
					<span class="field">
					<script id="editor" name="content" type="text/plain"><?php echo ($data["content"]); ?>
					</script>
				</span></p>
				<p><label>模版</label>
				<span class="formwrapper">
					<input type='text' name='temp' id='temp' value='<?php echo ($data["temp"]); ?>' class="smallinput20" />
				</span></p>
				<p><label>排序</label>
				<span class="formwrapper">
					<input type='text' name='sort' id='sort' value='<?php echo ($data["sort"]); ?>' class="smallinput20" validate='{required:true,isIntGteZero:true,messages:{required:"不能为空"}}'/>
				</span></p>
				<p><label>是否显示</label>
				<span class="formwrapper">
				...
				<p><label>描述</label>
				<span class="formwrapper">
					<input type='text' name='description' id='description' value='<?php echo ($data["description"]); ?>' class="smallinput20"/>
				</span></p>
				<p class="stdformbutton">
				<input type='hidden' name='id' value='<?php echo ($data["id"]); ?>'/>
					<input type="submit" class="submit radius2 " value="编辑"  />
				</p>
			</form>
			</div>
		</div><!--contentwrapper-->
