...
<div class="centercontent tables">
        <div class="pageheader notab">
            <h1 class="pagetitle20">邮件模板管理</h1>
            <span class="pagedesc">邮件模板管理</span>
        </div><!--pageheader-->
        <div id="contentwrapper" class="contentwrapper">
                <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <tbody>
                    <?php if(is_array($Emailtpl)): $i = 0; $__LIST__ = $Emailtpl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo["key"]); ?></td>
                            <td><?php echo ($vo["name"]); ?></td>
                            <td><?php echo ($vo["sort"]); ?></td>
                             <td class="center">
                           <?php if($vo[issend] == 1): ?><img  src="__PUBLIC__/Admin/images/icons/icon_1.png" alt="启用" title="启用">
					                          <?php else: ?>
					       <img  src="__PUBLIC__/Admin/images/icons/icon_0.png" alt="启用" title="启用"><?php endif; ?>
                             </td>
                            <td class="center">
                			    <a href="<?php echo U('Admin/Emailtpl/edit',array('id'=>$vo['key']));?>" class="edit">设置</a> &nbsp;
                            </td>
