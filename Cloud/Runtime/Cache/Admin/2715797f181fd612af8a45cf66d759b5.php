...
<div class="centercontent tables">
		<div class="pageheader notab">
			<h1 class="pagetitle20">客服管理</h1>
			<span class="pagedesc">客服管理</span>
		</div><!--pageheader-->
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
					...
					<thead>
						<tr>
							...
							<th class="head0">所在分组</th>
							<th class="head1">登录帐号</th>
							<th class="head0">客服名称</th>
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo["kefuloginname"]); ?></td>
							<td><?php echo ($vo["kefuname"]); ?></td>
							<td class="center">
								<?php if($vo[kefusex] == 1): ?>男<?php else: ?>女<?php endif; ?>
							</td>
							<td><?php echo ($vo["kefuqq"]); ?></td>
							<td><?php echo ($vo["kefutel"]); ?></td>
							<td class="center">
								<a href="<?php echo U('Admin/Kefu/edit',array('id'=>$vo['id']));?>" class="edit">编辑</a> &nbsp;
				 				<a href="<?php echo U('Admin/Kefu/del',array('id'=>$vo['id']));?>" class="confirmbutton">删除</a>
							</td>
