...
<div class="centercontent tables">
		...
		<div id="contentwrapper" class="contentwrapper">
			<div class="tableoptions">
				...
				用户类型
				<select name='user_rank' class="selectwidth20">
					<?php if(is_array($ranks)): $i = 0; $__LIST__ = $ranks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["rank_id"]); ?>'
						<?php if($vo[rank_id] == $prm_rid): ?>selected<?php endif; ?>
						><?php echo ($vo["rank_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select> &nbsp;
				<input type="text" name="username" id="username" value='<?php echo ($prm_uname); ?>' placeholder="用户名" autocomplete="off" value="" class="smallinput20"/>
				开始时间
			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				...
				<thead>
					<tr>
						...
						<th class="head0">用户类型</th>
						<th class="head1">客服</th>
						<th class="head0">余额</th>
						<th class="head1">email</th>
						<th class="head0">最后登录</th>
				...
				<tbody>
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="center"><?php echo ($vo["rank_name"]); ?></td>
						<td class="center"><?php echo ($vo["kefuname"]); ?></td>
						<td class="center"><?php echo ($vo["usermoney"]); ?></td>
						<td class="center"><?php echo ($vo["email"]); ?></td>
						<td class="center"><?php echo (date('Y-m-d H:i:s',$vo["lastlogintime"])); ?></td>
						<td class="center">
							<a href="<?php echo U('Admin/User/edit',array('id'=>$vo[user_id]));?>" class="edit">编辑</a> &nbsp;
							<a href="#del" >
							<span href="<?php echo U('Admin/User/del',array('id'=>$vo[user_id]));?>" class="confirmbutton">删除</span>
					  		</a>&nbsp;
						</td>
