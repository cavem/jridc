...
<div class="vernav2 iconmenu">
 ...
 <a class="togglemenu"></a>
		...
		<div class="pageheader notab">
			<h1 class="pagetitle20">添加客服组</h1>
			<span class="pagedesc">客服组添加</span>
		</div><!--pageheader-->
		<div id="contentwrapper" class="contentwrapper">
			<div id="basicform" class="subcontent">
			<form class="stdform formvalidate" action="<?php echo U('Admin/Kefu/rankadd');?>" method="post">
				<p><label>组名</label>
				<span class="field">
					<input type="text" name="rank_name" id="rank_name" class="smallinput20" validate='{required:true,messages:{required:"不能为空"}}' />
				</span></p>
