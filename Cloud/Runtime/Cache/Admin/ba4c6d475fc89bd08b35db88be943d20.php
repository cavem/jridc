...
<div class="centercontent tables">
		<div class="pageheader notab">
			<h1 class="pagetitle20">用户组管理</h1>
			<span class="pagedesc">用户组管理</span>
		</div><!--pageheader-->
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
					...
					<thead>
						<tr>
							...
							<th class="head0">用户组名称</th>
							<th class="head1">云主机折扣率</th>
							<th class="head1">云存储折扣率</th>
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td class="center"><?php echo ($vo["cloud_pers"]); ?></td>
							<td class="center"><?php echo ($vo["disk_pres"]); ?></td>
							<td class="center">
							...
							<td class="center">
								<a href="<?php echo U('Admin/Usergroup/edit',array('rank_id'=>$vo['rank_id']));?>" class="edit">编辑</a> &nbsp;
				 				<a href="<?php echo U('Admin/Usergroup/del',array('rank_id'=>$vo['rank_id']));?>" class="confirmbutton">删除</a>
							</td>
