...
<div class="centercontent tables">
		<div class="pageheader notab">
			<h1 class="pagetitle20">邀请码管理</h1>
			<span class="pagedesc">邀请码管理</span>
		</div><!--pageheader-->
		<div id="contentwrapper" class="contentwrapper">
		   <div class="tableoptions">
                	<form action="<?php echo U('Admin/Invite/index');?>" method="get">
                	用户名
			...
			<form class="stdform formvalidate" action="<?php echo U('Admin/Invite/del');?>" method="post">
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
					...
					<thead>
						<tr>
							...
							<th class="head0">客服</th>
							<th class="head1">邀请码</th>
							<th class="head0">有效周期</th>
							<th class="head1">状态</th>
							<th class="head0">使用者</th>
							<th class="head1">使用时间</th>
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo["kefuname"]); ?></td>
							<td><?php echo ($vo["usecode"]); ?></td>
							<td><?php echo ($vo["useday"]); ?></td>
							<td>
							...
							<td>
								<?php if($vo[usetime] == 0): ?>-
								<?php else: ?>
								<?php echo (date('Y-m-d H:i:s',$vo["usetime"])); endif; ?>
							</td>
							<td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
							<td class="center">
				 				<a href="<?php echo U('Admin/Invite/del',array('id'=>$vo['id']));?>" class="confirmbutton">删除</a>
							</td>
