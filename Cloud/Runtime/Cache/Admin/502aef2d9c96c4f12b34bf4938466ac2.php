 ...
 <a class="togglemenu"></a>
	...
	<div class="centercontent tables">
		<div class="pageheader notab">
			<h1 class="pagetitle20">客户组列表</h1>
			<span class="pagedesc">客户组管理</span>
		</div><!--pageheader-->
		<div id="contentwrapper" class="contentwrapper">
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td class="center">
								<a href="<?php echo U('Admin/Kefu/rankedit',array('rank_id'=>$vo['rank_id']));?>" class="edit">编辑</a> &nbsp;
				 				<a href="<?php echo U('Admin/Kefu/rankdel',array('rank_id'=>$vo['rank_id']));?>" class="confirmbutton">删除</a>
							</td>
