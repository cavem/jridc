...
<div class="centercontent tables">
		<div class="pageheader notab">
			<h1 class="pagetitle20">单页列表</h1>
			<span class="pagedesc">后台单页列表管理</span>
		</div><!--pageheader-->
		<div id="contentwrapper" class="contentwrapper">
			<div class="tableoptions">
		<!-- 		<form action="<?php echo U('Admin/Page/index');?>" method="get">
					标题
					<input type='text' name='prm_title' value="<?php echo ($prm_title); ?>"/>
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<a href="<?php echo U('Admin/Page/edit',array('id'=>$vo['id']));?>" class="edit">编辑</a> &nbsp;
					 			<a href="#del" >
					  			<span href="<?php echo U('Admin/Page/del',array('id'=>$vo['id']));?>" class="confirmbutton">删除</span>
					  			</a> &nbsp;
							</td>
