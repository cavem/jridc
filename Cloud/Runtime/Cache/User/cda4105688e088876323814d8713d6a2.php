...
<title>我的账户-<?php echo ($Web["Config"]["site_name"]); ?></title>
...
<!--菜单-->
	...
	<div class="main">
		...
		<div class="mainM">
			<p class="mainTson"><b>账号名称：</b><?php echo ($user_info["username"]); ?></p>
			<div class="accDiv" id="balance">
				<p class="font14">账号余额：</p>
				<p class="font14M"><b><?php echo ($user_info["usermoney"]); ?></b>元 <span class="aSpan"><a class="btn btnOrg2" href="<?php echo U('User/Pay/index');?>">立即充值</a></span></p>
			</div>
		</div>
	</div>
</div>
