...
<style type="text/css">
    ...
    .alert .alert_body .success{ background:url('__PUBLIC__/User/images/success.gif') left center no-repeat; }
    .alert .alert_body .error{ background:url('__PUBLIC__/User/images/error.gif') left center no-repeat; }
